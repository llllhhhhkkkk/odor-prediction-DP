...
class MPNNPOM(nn.Module):
    ...
    * Perform the final prediction using a feed-forward layer.
    ...
    def __init__(self,
                 ...
                 feature_visualization: bool = False):
        """
        Parameters
        ----------
        n_tasks: int
        ...
        self.feature_visualization: bool = feature_visualization
    ...
    def forward(
        ...
        * When self.mode = 'classification',
        ...
        if self.feature_visualization:
            molecular_encodings_tsne = molecular_encodings.detach().cpu().numpy()
            features = molecular_encodings_tsne.reshape(-1)
            ...
            ax.set_title('Radar Chart of Molecular Encodings')
            plt.show()
    ...
    * Perform the final prediction using a feed-forward layer.
    ...
    def __init__(self,
        ...
        model: nn.Module = MPNNPOM(
            ...
            feature_visualization=kwargs.get('feature_visualization', False))
