...
class CustomMPNNGNN(MPNNGNN):
    ...
    def __init__(self,
        ...
        self.gnn_layer = DGNConv(in_size=node_out_feats,
    ...
    def forward(self, g, node_feats, edge_feats):
        ...
        g = transform(g)
        eig_feats = g.ndata['eig']

        for _ in range(self.num_step_message_passing):
            node_feats = F.relu(self.gnn_layer(g, node_feat=node_feats, edge_feat=edge_feats, eig_vec=eig_feats))
