    ...
    * Perform the final prediction using a feed-forward layer.
    ...
    def forward(
        ...
        def average_features(features):
            # features: list of tensors, each [128, 400]
            # 计算平均值
        ...
        * When self.mode = 'classification',
        ...
        feature_list = [molecular_encodings, molecular_encodings_scene, molecular_encodings_rgcn]
        combined_features = average_features(feature_list)
